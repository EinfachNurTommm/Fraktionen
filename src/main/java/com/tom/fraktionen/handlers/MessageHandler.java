...
public class MessageHandler {
    ...
    public MessageHandler() {
        ...
        this.configuration.addDefault("Commands.DisplayAccept", "%prefix% /faction accept | &eAkzeptiert eine Fraktionseinladung");
        this.configuration.addDefault("Commands.DisplayKick", "%prefix% /faction uninvite [Spieler] | &eKickt einen Spieler aus einer Fraktion");
        ...
        this.configuration.addDefault("Commands.DisplayList", "%prefix% /faction list | &eListet alle Fraktionen auf");
        ...
        this.configuration.addDefault("Commands.MessageNoPlayer", "%prefix% &cDer Spieler &e%name% &cexistiert nicht!");
